...
namespace BinaryTreeImplementation
{
        ...
        where T: IComparable<T>
    {
        ...
        public void Add(T value)
        {
            ...
            // Case 2: The tree is not empty so find the correct location to insert
            else
            {
                AddTo(_head, value);
            }
        ...
        private void AddTo(BinaryTreeNode<T> node, T value)
        {
            ...
            if (value.CompareTo(node.Value) < 0)
            {
                ...
                if (node.Left == null)
                {
                    ...
                    Debug.WriteLine($"Node left was added to {node.Value} node; new node is for the value {value}");
                }
                else
                {
            ...
            else
            {
                ...
                if (node.Right == null)
                {
                    ...
                    Debug.WriteLine($"Node right was added to {node.Value} node; new node is for the value {value}");
                }
                else
                {
